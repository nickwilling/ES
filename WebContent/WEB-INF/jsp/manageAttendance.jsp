...
<body>
	<form>
		<span>输入班级号：</span><input class="inputID" type="text" name="batch">
		<br> <br> <span>输入开始时间：</span><input class="inputID"
			type="date" name="beginDate"> <br> <br> <span>输入结束时间：</span><input
			class="inputID" type="date" name="endDate"> <br> <br>
		<input type="submit" class="btn btn-primary addbtn" value="查询"
